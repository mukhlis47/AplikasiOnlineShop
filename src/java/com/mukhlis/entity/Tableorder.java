...
public class Tableorder implements Serializable {
    ...
    @ManyToOne
    private Tablecustomers customerId;
    ...
    public Tablecustomers getCustomerId() {
        return customerId;
    }

    public void setCustomerId(Tablecustomers customerId) {
    ...
    public String toString() {
        return "com.mukhlis.entity.Tableorder[ id=" + id + " ]";
    }
